...
- **Unofficial surface.** The InnerTube endpoint is not a public API and can change without notice. If removals start failing with HTTP 400, the request shape changed — see `src/innertube.ts`.
